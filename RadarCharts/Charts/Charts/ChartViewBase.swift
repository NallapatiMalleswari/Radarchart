...
{
     public static let TOUCH_POINT_TO_HIGHLIGHT = NSNotification.Name(rawValue: "TOUCH_POINT_TO_HIGHLIGHT")
    ...
    @objc open func highlightValue(_ highlight: Highlight?, callDelegate: Bool)
    {
        ...
        if callDelegate, let delegate = delegate
        {
            if let h = h
            {
                ...
                NotificationCenter.default.post(name: ChartViewBase.TOUCH_POINT_TO_HIGHLIGHT, object: h)
